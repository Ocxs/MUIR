...
def process_args(args):
  ...
  parser.add_argument('--emb-dim', type=int, default=8, help='dim of embedding')
  parser.add_argument('--interaction', type=str, default='inner', help='interaction method')
  parser.add_argument('--agg-layers', type=int, nargs='+', default=[32], help='aggregation layer')
  parser.add_argument('--neighbor-length', type=int, default=20, help='number of user\'s neighbor')
  ...
  parser.add_argument('--neighbor-sample' , type=str, default='uniform', choices=['uniform', 'weighted'],
                      help='which type neighbors to use')
...
def init_logging(args):
  log_name = os.path.join(args.out_dir, '{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}.log'.format(
    ...
    args.neighbor_length, args.neighbor_sample,
  ...
  logging.info('neighbor_length: {}'.format(args.neighbor_length))
  logging.info('neighbor_sample: {}'.format(args.neighbor_sample))
  logging.info('--------------------')


def main(args):
  args = process_args(args)
  directory = '{}'.format("NIN_Movie")
