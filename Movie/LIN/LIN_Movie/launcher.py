...
def process_args(args):
  ...
  parser.add_argument('--max-epoch', type=int, default=10, help='the number of epochs')
  parser.add_argument('--lr', type=float, default=0.001, help='initial learning rate')
  parser.add_argument('--optimizer', type=str, default='adam', help='optimizer')
  parser.add_argument('--w-reg', type=float, default=0, help='regularization coefficient for network parameters')
  parser.add_argument('--emb-reg', type=float, default=0, help='regularization coefficient for network parameters')
  ...
  parser.add_argument('--emb-dim', type=int, default=16, help='dim of embedding')
  parser.add_argument('--interaction', type=str, default='product', help='interaction method')
  parser.add_argument('--agg-layers', type=int, nargs='+', default=[], help='aggregation layer')
