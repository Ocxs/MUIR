...
class Solver(object):
  def __init__(self, model, args):
    ...
    sub_dir = '{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}'.format(
  ...
  def eval(self, sess, epoch, save_pred=False):
    ...
    if save_pred:
      np.save(os.path.join(self.out_dir, 'IIN_Movie_pred_{}_{}_{}.npy'.format(self.emb_dim,
                                                                              self.hist_length,
                                                                              self.dropout_keep)), pred_dict)
    ...
    logging.info('epoch: {}- test  loss: {:.4f} in {:.2f}s, auc:{:.4f}, precision:{:.4f}, '
                 'recall:{:.4f}, ndcg:{:.4f} in top10 , {} samples'.format(epoch + 1, test_loss, end_time, auc,
                                                                           p_k[0],
