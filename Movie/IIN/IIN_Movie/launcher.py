...
def process_args(args):
  ...
  parser.add_argument('--batch-size', type=int, default=2048, help='batch_size')
  parser.add_argument('--max-epoch', type=int, default=2, help='the number of epochs')
  parser.add_argument('--lr', type=float, default=0.001, help='initial learning rate')
  parser.add_argument('--optimizer', type=str, default='adam', help='optimizer')
  parser.add_argument('--w-reg', type=float, default=1e-5, help='regularization coefficient for network parameters')
  parser.add_argument('--emb-reg', type=float, default=1e-7, help='regularization coefficient for network parameters')
  parser.add_argument('--dropout-keep', type=float, default=1.0, help='The probability that each element is kept.')
  ...
  parser.add_argument('--agg-layers', type=int, nargs='+', default=[32], help='aggregation layer')
  parser.add_argument('--hist-length', type=int, default=40, help='number of historical items in IIN')
  ...
  parser.add_argument('--hist-sample', type=str, default='fix', help='which strategy to use for sampling history')
  parser.add_argument('--att-dropout', type=float,  default=1.0, help='attention dropout')

  parser.add_argument('--n-users', type=int, default=51001, help='number of users')
  parser.add_argument('--n-items', type=int, default=10380, help='number of items')
  parser.add_argument('--n-cates', type=int, default=19, help='number of categories')

  parameters = parser.parse_args(args)
  return parameters

def init_logging(args):
  log_name = os.path.join(args.out_dir, '{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}.log'.format(
  ...
  logging.info('hist_length: {}'.format(args.hist_length))
  logging.info('hist_sample: {}'.format(args.hist_sample))
  logging.info('att_dropout: {}'.format(args.att_dropout))
  logging.info('--------------------')


def main(args):
  args = process_args(args)
  directory = '{}'.format("IIN_Movie")
