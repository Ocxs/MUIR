...
class Model(object):
  ...
  def build_model(self,
    ...
    with tf.variable_scope('feature_representation'):
      ...
      hist_visual_feat = tf.nn.embedding_lookup(self.visual_feature, hist_iids)
      hist_visual_emb = dense(hist_visual_feat, self.emb_dim, ['w2'], keep_prob)
