...
def process_args(args):
  ...
  parser.add_argument('--hist-length', type=int, default=160, help='number of historical items in IIN')
  ...
  parser.add_argument('--hist-sample', type=str, default='fix', help='which sample strategy to use')
