...
class Solver(object):
  def __init__(self, model, args):
    ...
    sub_dir = '{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}'.format(
      ...
      args.hist_length, args.hist_sample
    )
  ...
  def eval(self, sess, epoch, save_pred=False):
    ...
    if save_pred:
      np.save(os.path.join(self.out_dir, 'IIN_Video_pred_{}_{}.npy'.format(self.emb_dim, self.hist_length)), pred_dict)
