...
def process_args(args):
  ...
  parser.add_argument('--max-epoch', type=int, default=20, help='the number of epochs')
  ...
  parser.add_argument('--neighbor-length', type=int, default=30, help='number of neighbor user in NIN')
...
def init_logging(args):
  log_name = os.path.join(args.out_dir, '{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}.log'.format(
