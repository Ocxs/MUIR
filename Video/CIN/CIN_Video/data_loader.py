...
class DataLoader(object):
  ...
  def load_data_from_disk(self):
    ...
    logging.info('load user click distribution upon category')
    path = os.path.join(self.data_dir, 'Video/user_click_cate_distribution.npy')
    self.user_click_cate_distribution = np.load(path)
